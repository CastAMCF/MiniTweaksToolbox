...
namespace MiniTweaksToolbox
{
	internal static class Main
	{
        ...
        {
            GUILayout.Box("<b>Your current CMS2018 Version is " + Application.version + " (" + GameSettings.m_buildVersion + ")</b>", Array.Empty<GUILayoutOption>());

            ModKit.UI.Space(2f);
            ModKit.UI.Label("Note ".magenta().bold() + "If you get some frame drops close this mod option tab".orange().bold(), Array.Empty<GUILayoutOption>());
            ModKit.UI.Space(2f);
