...
namespace ModKit.Utility {
    public static class StringExtensions {
        ...
        public static string MarkedSubstringNoHTML(this string source, string sub) {
            if (string.IsNullOrEmpty(source) || string.IsNullOrEmpty(source.Trim()) || string.IsNullOrEmpty(sub) || string.IsNullOrEmpty(sub.Trim()))
                return source;
        ...
        public static string MarkedSubstring(this string source, string query) {
            if (string.IsNullOrEmpty(source) || string.IsNullOrEmpty(source.Trim()) || string.IsNullOrEmpty(query) || string.IsNullOrEmpty(query.Trim()))
                return source;
