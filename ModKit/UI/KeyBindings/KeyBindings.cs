...
namespace ModKit {
    public static partial class UI {
        ...
        public static class KeyBindings {
            ...
            private static readonly Dictionary<string, ActionEntry> actions = new() { };
            ...
            public static ActionEntry? GetAction(string identifier) {
            ...
            public static void RegisterAction(string identifier, Action action, Func<string, string> description = null) 
                => actions[identifier] = new ActionEntry(action, description);
            public class ActionEntry
            {
                public Action Action { get; private set; }
                public Func<string, string> Description { get; private set; }

                public ActionEntry(Action action, Func<string, string> description)
                {
                    Action = action;
            ...
            internal static void SetBinding(string identifier, KeyBind binding) {
                ...
                modEntry.SaveSettings("bindings.xml", bindings);
                BindingsDidChange = true;
            }
            ...
            public static void OnLoad(ModEntry modEntry) {
                ...
                if (bindings == null) {
                    SettingsController.LoadSettings(modEntry, "bindings.xml", ref bindings);
                    BindingsDidChange = true;
                }
            }
